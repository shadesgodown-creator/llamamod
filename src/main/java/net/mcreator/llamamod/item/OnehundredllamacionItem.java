...
public class OnehundredllamacionItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:onehundredllamacion")
	public static final Item block = null;
	public OnehundredllamacionItem(LlamaModModElements instance) {
		super(instance, 94);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("onehundredllamacion");
		}
