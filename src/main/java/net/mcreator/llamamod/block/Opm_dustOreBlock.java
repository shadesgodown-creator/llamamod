...
import net.mcreator.llamamod.item.Opm_dustDustItem;
...
public class Opm_dustOreBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:opm_dust_ore")
	public static final Block block = null;
	public Opm_dustOreBlock(LlamaModModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Opm_dustDustItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("opm_dust_ore", "opm_dust_ore", blockAt -> {
