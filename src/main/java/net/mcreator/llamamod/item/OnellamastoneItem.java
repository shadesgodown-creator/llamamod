...
public class OnellamastoneItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:onellamastone")
	public static final Item block = null;
	public OnellamastoneItem(LlamaModModElements instance) {
		super(instance, 91);
	}
