...
public class Opm_dustBlockBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:opm_dust_block")
	public static final Block block = null;
	public Opm_dustBlockBlock(LlamaModModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("opm_dust_block");
		}
