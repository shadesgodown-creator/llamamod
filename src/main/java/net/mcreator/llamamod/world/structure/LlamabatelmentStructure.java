...
public class LlamabatelmentStructure extends LlamaModModElements.ModElement {
	public LlamabatelmentStructure(LlamaModModElements instance) {
		super(instance, 87);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("llama_mod", "battelment"));
						if (template == null)
							return false;
