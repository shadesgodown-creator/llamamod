...
public class HouseStructure extends LlamaModModElements.ModElement {
	public HouseStructure(LlamaModModElements instance) {
		super(instance, 86);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 100) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("llama_mod", "house"));
						if (template == null)
							return false;
