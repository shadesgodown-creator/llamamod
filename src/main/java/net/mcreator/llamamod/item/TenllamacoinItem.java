...
public class TenllamacoinItem extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:tenllamacoin")
	public static final Item block = null;
	public TenllamacoinItem(LlamaModModElements instance) {
		super(instance, 93);
	}
