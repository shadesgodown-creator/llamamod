...
public class OpmStructure extends LlamaModModElements.ModElement {
	public OpmStructure(LlamaModModElements instance) {
		super(instance, 89);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("llama_mod", "opm"));
						if (template == null)
							return false;
