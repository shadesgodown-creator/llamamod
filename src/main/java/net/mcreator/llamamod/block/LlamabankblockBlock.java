...
import net.mcreator.llamamod.gui.LlamabankGui;
...
public class LlamabankblockBlock extends LlamaModModElements.ModElement {
	@ObjectHolder("llama_mod:llamabankblock")
	public static final Block block = null;
	public LlamabankblockBlock(LlamaModModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("llamabankblock");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Llamabankblock");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new LlamabankGui.GuiContainerMod(id, inventory,
